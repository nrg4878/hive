...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class CompactionRequest implements org.apache.thrift.TBase<CompactionRequest, CompactionRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CompactionRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new HashMap<String,String>(2*_map772.size);
                String _key773;
                String _val774;
                for (int _i775 = 0; _i775 < _map772.size; ++_i775)
                {
                  ...
                  struct.properties.put(_key773, _val774);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter776 : struct.properties.entrySet())
            {
  ...
  private static class CompactionRequestTupleScheme extends TupleScheme<CompactionRequest> {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (Map.Entry<String, String> _iter777 : struct.properties.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CompactionRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map778 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.properties = new HashMap<String,String>(2*_map778.size);
          String _key779;
          String _val780;
          for (int _i781 = 0; _i781 < _map778.size; ++_i781)
          {
            ...
            struct.properties.put(_key779, _val780);
          }
        }
        struct.setPropertiesIsSet(true);
      }
