            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.eventTypeSkipList = new ArrayList<String>(_list798.size);
                String _elem799;
                for (int _i800 = 0; _i800 < _list798.size; ++_i800)
                {
                  _elem799 = iprot.readString();
                  struct.eventTypeSkipList.add(_elem799);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.eventTypeSkipList != null) {
        if (struct.isSetEventTypeSkipList()) {
          oprot.writeFieldBegin(EVENT_TYPE_SKIP_LIST_FIELD_DESC);
          {
            ...
            for (String _iter801 : struct.eventTypeSkipList)
            {
      ...
      if (struct.isSetEventTypeSkipList()) {
        {
          ...
          for (String _iter802 : struct.eventTypeSkipList)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.eventTypeSkipList = new ArrayList<String>(_list803.size);
          String _elem804;
          for (int _i805 = 0; _i805 < _list803.size; ++_i805)
          {
            _elem804 = iprot.readString();
            struct.eventTypeSkipList.add(_elem804);
          }
        }
        struct.setEventTypeSkipListIsSet(true);
      }
