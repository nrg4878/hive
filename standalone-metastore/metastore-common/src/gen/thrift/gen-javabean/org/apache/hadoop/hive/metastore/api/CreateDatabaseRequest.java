...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class CreateDatabaseRequest implements org.apache.thrift.TBase<CreateDatabaseRequest, CreateDatabaseRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CreateDatabaseRequest> {
  ...
  static {
    schemes.put(StandardScheme.class, new CreateDatabaseRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CreateDatabaseRequestTupleSchemeFactory());
  }

  private String databaseName; // required
  private String description; // optional
  private String locationUri; // optional
  ...
  private String dataConnectorName; // optional
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DATA_CONNECTOR_NAME:
      if (value == null) {
        ...
        setDataConnectorName((String)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_dataConnectorName = true && (isSetDataConnectorName());
    list.add(present_dataConnectorName);
    if (present_dataConnectorName)
      list.add(dataConnectorName);
  ...
  public int compareTo(CreateDatabaseRequest other) {
    ...
    lastComparison = Boolean.valueOf(isSetDataConnectorName()).compareTo(other.isSetDataConnectorName());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  private static class CreateDatabaseRequestStandardSchemeFactory implements SchemeFactory {
    public CreateDatabaseRequestStandardScheme getScheme() {
      return new CreateDatabaseRequestStandardScheme();
    }
  }

  private static class CreateDatabaseRequestStandardScheme extends StandardScheme<CreateDatabaseRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameters = new HashMap<String,String>(2*_map1154.size);
                String _key1155;
                String _val1156;
                for (int _i1157 = 0; _i1157 < _map1154.size; ++_i1157)
                {
                  _key1155 = iprot.readString();
                  _val1156 = iprot.readString();
                  struct.parameters.put(_key1155, _val1156);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.parameters != null) {
        if (struct.isSetParameters()) {
          oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter1158 : struct.parameters.entrySet())
            {
              oprot.writeString(_iter1158.getKey());
              oprot.writeString(_iter1158.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class CreateDatabaseRequestTupleSchemeFactory implements SchemeFactory {
    public CreateDatabaseRequestTupleScheme getScheme() {
      return new CreateDatabaseRequestTupleScheme();
    }
  }

  private static class CreateDatabaseRequestTupleScheme extends TupleScheme<CreateDatabaseRequest> {
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (Map.Entry<String, String> _iter1159 : struct.parameters.entrySet())
          {
            oprot.writeString(_iter1159.getKey());
            oprot.writeString(_iter1159.getValue());
          }
        }
      }
      if (struct.isSetPrivileges()) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CreateDatabaseRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map1160 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.parameters = new HashMap<String,String>(2*_map1160.size);
          String _key1161;
          String _val1162;
          for (int _i1163 = 0; _i1163 < _map1160.size; ++_i1163)
          {
            _key1161 = iprot.readString();
            _val1162 = iprot.readString();
            struct.parameters.put(_key1161, _val1162);
          }
        }
        struct.setParametersIsSet(true);
      }
